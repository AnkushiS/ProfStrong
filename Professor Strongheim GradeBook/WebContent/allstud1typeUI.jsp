...
<nav class="navbar navbar-default">
	...
	<form action="allstud1type" method="post" class="bs-example">
		<h3>All student one assignment type</h3>
        <div class="form-group" style="width:30%">
            <label for="assign_type">Assignment type</label>
            <input  type="text" class="form-control" name="assign_type" placeholder="assign type">
            <input style=margin-top:30 type="submit" value="submit" name="actSubmit" >
